...
/***/ function(module, exports, __webpack_require__) {
	...
	var _container = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dummy = _immutable2.default.fromJS({
	  "productsInCart": [{
	    "p_id": "1",
	...
	function reducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? dummy : arguments[0];
	  var action = arguments[1];
	  ...
	  switch (action.type) {
	    case 'ADD_TODO':
	      ...
	      arr = arr.push((0, _immutable.Map)(action.payload));
	      return state.set('productsInCart', arr);
	    case 'TOGGLE_TODO':
	      arr = state.get('productsInCart').map(function (t) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CartListWrapper = __webpack_require__(193);

	var _CartListWrapper2 = _interopRequireDefault(_CartListWrapper);

	var _actions = __webpack_require__(196);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var CartListContainer = (0, _reactRedux.connect)(function mapStateToProps(state) {
	  console.log(state.get('productsInCart'));
	  return { itemsList: state.get('productsInCart') };
	...
	})(_CartListWrapper2.default);

	exports.default = CartListContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = CartListWrapper;

	var _react = __webpack_require__(1);

	var _react2 = _interopRequireDefault(_react);

	var _cartlist = __webpack_require__(194);

	var _cartlist2 = _interopRequireDefault(_cartlist);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	// SubzTotal shoul add below to CartList

	function CartListWrapper(props) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CartList = function (_React$Component) {
	  ...
	  function CartList(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CartList).call(this, props));
	  }

	  _createClass(CartList, [{
	    key: 'render',
	    value: function render() {
	      var ListItemsJSX = this.props.itemsList.map(function (item) {
	        return _react2.default.createElement(_CartItem2.default, { item: item });
	      });
	      return { ListItemsJSX: ListItemsJSX };
	    }
	  }]);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "content-section default-border-bottom" },
	          _react2.default.createElement(
	            "div",
	            { className: "left-section" },
	            _react2.default.createElement("img", { src: "./images/T1.jpg", alt: "" })
	          ),
	          _react2.default.createElement(
	            "div",
	            { className: "right-top" },
	            _react2.default.createElement(
	              "div",
	              { className: "section product-description margin-right200" },
	              _react2.default.createElement(
	                "h4",
	                null,
	                item.p_name
	            ...
	            _react2.default.createElement(
	              "div",
	              { className: "section margin-right30" },
	              "$"
	            ),
	            _react2.default.createElement(
	              "div",
